 ...
 */
public class FragmentMap extends SupportMapFragment implements ClusterManager.OnClusterClickListener<Person>, ClusterManager.OnClusterInfoWindowClickListener<Person>, ClusterManager.OnClusterItemClickListener<Person>, ClusterManager.OnClusterItemInfoWindowClickListener<Person>  {
	/**
	...
	private void onInitData() {
		mClusterManagerPerson = new ClusterManager<Person>(getActivity(), getMap());
		...
		getMap().moveCamera(
				CameraUpdateFactory.newLatLngZoom(new LatLng(10.85642465,106.6307473),13f));
...
//		onInitBigClusterData();
	...
	public void onInitBigClusterData(){
		...
		mClusterManagerItem = new ClusterManager<MyItem>(getActivity(), getMap());
	...
	public boolean onClusterClick(Cluster<Person> cluster) {
		...
		ToastUtil.showToast(cluster.getSize() + " (including " + firstName + ")", getActivity());
		return true;
	}
	...
	private void addItems() {
		...
		mClusterManagerPerson
				.addItem(new Person(position(), "Gran", R.drawable.gran));

		// http://www.flickr.com/photos/nypl/3111525394/
		mClusterManagerPerson
				.addItem(new Person(position(), "Ruth", R.drawable.ruth));
		...
		mClusterManagerPerson
				.addItem(new Person(position(), "John", R.drawable.john));

		// http://www.flickr.com/photos/anmm_thecommons/7694202096/
		mClusterManagerPerson.addItem(new Person(position(), "Trevor the Turtle",
				R.drawable.turtle));
	...
	private LatLng position() {
		return new LatLng(random(10.84774219, 10.86504364), random(106.6181946, 106.6402102));
	}
